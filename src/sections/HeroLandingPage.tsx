            ...
            <Container maxWidth='xl' >
                <Grid container sx={{ alignItems: 'center', minHeight: '100vh' }} columnSpacing={12}>
                    <Grid item xs={12} md={6}>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, mb: 8, flexDirection: { xs: 'column', sm: 'row' } }}>
                        ...
                        <Box sx={{ background: 'rgba(255,255,255,.4)', borderRadius: 4, p: 2, backdropFilter: 'blur(20px)', border: 'solid 1px rgba(0,0,0,.12)', maxWidth: '65%' }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexDirection: 'row' }}>
                                ...
                                <Box>
                                    <Typography sx={{ fontWeight: 600, color: theme.palette.primary.main }} variant='body2' gutterBottom>Michael Douglas</Typography>
